...
namespace BTKUILib.UIObjects.Components
{
    ...
    public class SliderFloat : QMUIElement
    {
        ...
        internal SliderSettings SliderSettings;
        ...
        private bool _noCohtmlGenerate;

        internal SliderFloat(QMUIElement parent, string sliderName, string sliderTooltip, float initalValue, float minValue = 0f, float maxValue = 10f, int decimalPlaces = 2, float defaultValue = 0f, bool allowDefaultReset = false, bool inCategoryMode = false, bool noCohtmlGenerate = false)
        {
            ...
            _noCohtmlGenerate = noCohtmlGenerate;
            Parent = parent;
        ...
        {
            if (!UIUtils.IsQMReady() || _noCohtmlGenerate) return;
            ...
            if (!IsGenerated)
            {
                ...
                UIUtils.GetInternalView().TriggerEvent("btkCreateSlider", Parent.ElementID, UUID, _sliderValue, _inCategoryMode, SliderSettings);
            }
        ...
        private void UpdateSlider()
        {
            ...
            UIUtils.GetInternalView().TriggerEvent("btkSliderUpdateSettings", UUID, SliderSettings);
            UIUtils.GetInternalView().TriggerEvent("btkSliderSetValue", UUID, SliderValue);
        }
    }

    internal struct SliderSettings
    {
        public string SliderName;
        public string SliderTooltip;
        public float MinValue;
